 ...
 */
package org.apache.solr.analytics.values.constant;
...
public abstract class ConstantValue {
  ...
  private static final SimpleDateFormat dateParserBase = new SimpleDateFormat("yyyy-MM-dd");
  private static final SimpleDateFormat dateParser1 = new SimpleDateFormat("yyyy-MM-ddZ");
  private static final SimpleDateFormat dateParser2 = new SimpleDateFormat("yyyy-MM-ddXXX");
  private static final SimpleDateFormat dateParser3 = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ssZ");
  private static final SimpleDateFormat dateParser4 = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ssXXX");
  private static final SimpleDateFormat dateParser5 = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss.SSSZ");
  private static final SimpleDateFormat dateParser6 = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss.SSSXXX");
